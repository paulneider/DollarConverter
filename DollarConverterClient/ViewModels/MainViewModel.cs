...
static class Converter
{
    internal static string Convert(double value)
    {
        ...
        {
            numeral = numeral.AddSpace() + $"{GetNumeral1To999(thousandsQuantity)} thousand";
        }
        ...
        if (quantity > 0)
        {
            ...
            {
                numeral = numeral.AddSpace() + $"{GetNumeral1To999(quantity)} dollars";
            }
        }
        ...
        if (centQuantity > 1)
        {
            numeral = numeral.AddSpace() + $"and {GetNumeral1To999(centQuantity)} cents";
        }
        else if (centQuantity == 1)
        {
            numeral = numeral.AddSpace() + "and one cent";
        }
    ...
    static string GetNumeral1To999(int value)
    {
        ...
        {
            // 1 - 9
            numeral = numeral.AddSpace() + GetNumeral1To9(inputWithOutHundred);
        }
        else if (inputWithOutHundred > 10 && inputWithOutHundred < 20)
        {
            // 11 - 19
            numeral = numeral.AddSpace() + GetNumeral11To19(inputWithOutHundred);
        }
        else
        {
            // 10 && 20 - 99
            numeral = numeral.AddSpace() + GetTensNumeral(tensQuantity);
    ...
    static string AddSpace(this string value)
    {
